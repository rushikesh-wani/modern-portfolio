...
export const R = () => {
  return (
    <div className="">
      ...
      <p className="text-xs text-center">R</p>
    </div>
  );
};
...
export const ReactJs = () => {
  return (
    <div className="">
      ...
      <p className="text-xs text-center">ReactJs</p>
    </div>
  );
};
export const ReactJsFloat = () => {
  return (
    <div className="">
      <svg
        className="drop-shadow-2xl mx-auto"
...
export const ReduxJs = () => {
  return (
    <div className="">
      ...
      <p className="text-xs text-center">Redux JS</p>
    </div>
  );
};
export const ReduxJsFloat = () => {
  return (
    <div className="">
      <svg
        className="drop-shadow-2xl mx-auto"
...
export const GitHub = () => {
  return (
    <div className="">
      <svg
        className="drop-shadow-2xl mx-auto dark:fill-white"
        xmlns="http://www.w3.org/2000/svg"
        x="0px"
        y="0px"
        width="50"
...
export const ProjectList = [
  {
    ...
    Img: "../assets/project/Project01.png",
    ProjectDescrp:
      "Developed a full-stack CRUD application using the MERN stack for efficient data management and user interaction. Features include a user-friendly interface, robust backend, scalable database, responsive design, and deployment on Render.",
    Tags: ["MERN Stack"],
    LiveLink: "",
    GithubLink: "",
  },
