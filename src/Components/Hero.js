      ...
      <div className="md:h-screen px-5 pt-20 md:py-20 lg:px-40 flex flex-col-reverse justify-around items-center md:flex-row gap-5">
        ...
        <div className="Right-div ">
          <div className=" relative flex justify-center pt-10 px-10">
            ...
            <div className="absolute top-3 -left-0 w-14 h-14 rounded-full flex justify-center items-center bg-white shadow-lg transition-shadow">
              <TailwindFloat className="" />
            </div>
            <div className="absolute top-8 right-8 w-10 h-10 rounded-full flex justify-center items-center bg-white shadow-xl">
              <ReduxJsFloat />
            </div>
            <div className="absolute bottom-10 left-2 w-11 h-11 rounded-full flex justify-center items-center bg-white shadow-lg">
              <VSCodeFloat />
            </div>
            <div className="absolute bottom-0 md:bottom-10 right-2 md:-right-1 w-14 h-14 rounded-full flex justify-center items-center bg-white shadow-lg">
              <ReactJsFloat />
            </div>
            <div className="absolute top-28 md:top-36 -right-3 w-12 h-12 rounded-full flex justify-center items-center bg-white shadow-lg">
              <HTMLFloat />
            </div>
          </div>
        </div>
