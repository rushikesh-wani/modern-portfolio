...
const Projects = () => {
  return (
    <section className="px-5 pb-5 md:pb-10 lg:px-40 duration-1000">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 place-items-center py-4 md:py-10 gap-4">
        <div className="relative bg-white h-fit dark:bg-gray-700/50 p-3 rounded-xl shadow-lg">
          ...
          <p className="font-montserrat text-sm my-2">
